...
class Network(object):
    ...
    def dropout(self, input, keep_prob, name):
        return tf.nn.dropout(input, keep_prob, name=name, seed=1)
    ...
    #     #     if reuse:
    #     #         tf.get_variable_scope().reuse_variables()
    #     #     sbjs_scr = tf.gather(input, relations[:,0])[:,1:]
    #     #     objs_scr = tf.gather(input,relations[:,1])[:,1:]
		# #
		# #
    #     #     print objs_scr.get_shape()
    #     #     print objs_scr.get_shape()
		# #
    #     #     print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
    #     return input