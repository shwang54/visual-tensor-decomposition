...
def eval_relation_recall(sg_entry,
    ...
    #print(predicate_preds.shape)
    #print(predicate_preds)

    # no bg
    predicate_preds = predicate_preds[:, :, 1:]
    #print('np.array(predicate_preds).shape')
    #print(np.array(predicate_preds).shape)
    ...
    #print('np.array(predicate_scores).shape')
    #print(np.array(predicate_scores).shape)
    #print('predicate_scores')
    #print(predicate_scores)
    relations = []
    keep = []
    ...
    #print(classes)
    #print(classes.shape)
    classes = classes[:num_boxes]
    class_scores = class_scores[:num_boxes]
